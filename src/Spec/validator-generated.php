...
class ValidationRulesFactory {
  ...
  $o_0->error_formats[] = $o_1287;
      ...
      $o_9999 = new TagSpec();
      $o_9999->tag_name = 'amp-app-banner';
      $o_0->tags[] = $o_9999;

      $o_1288 = new TagSpec();
      $o_1288->tag_name = 'script';
      $o_1288->spec_name = 'amp-script extension .js script';
      $o_1288->mandatory_parent = 'head';
      $o_1289 = new AttrSpec();
      $o_1289->name = 'async';
      ...
      $o_1288->attrs[] = $o_1289;
      $o_1290 = new AttrSpec();
      $o_1290->name = 'custom-element';
      $o_1290->mandatory = true;
      $o_1290->value = 'amp-script';
      $o_1290->dispatch_key = true;
      $o_1288->attrs[] = $o_1290;
      $o_1291 = new AttrSpec();
      $o_1291->name = 'src';
      $o_1291->mandatory = true;
      $o_1291->value_regex = 'https://cdn\\.ampproject\\.org/v0/amp-script-(latest|0\\.1)\\.js';
      $o_1288->attrs[] = $o_1291;
      $o_1292 = new AttrSpec();
      $o_1292->name = 'type';
      $o_1292->value = 'text/javascript';
      $o_1288->attrs[] = $o_1292;
      $o_1288->spec_url = 'https://www.ampproject.org/docs/reference/extended/amp-script.html';
      $o_1293 = new CdataSpec();
      $o_1294 = new BlackListedCDataRegex();
      $o_1294->regex = '.';
      $o_1294->error_message = 'contents';
      $o_1293->blacklisted_cdata_regex[] = $o_1294;
      $o_1288->cdata = $o_1293;
      $o_0->tags[] = $o_1288;
      $o_1295 = new TagSpec();
      $o_1295->tag_name = 'amp-script';
      $o_1296 = new AttrSpec();
      $o_1296->name = 'type';
      ...
      $o_1299->supported_layouts = [AmpLayoutLayout::CONTAINER, AmpLayoutLayout::FILL, AmpLayoutLayout::FIXED, AmpLayoutLayout::FIXED_HEIGHT, AmpLayoutLayout::FLEX_ITEM, AmpLayoutLayout::NODISPLAY, AmpLayoutLayout::RESPONSIVE];
