...
class ValidationRulesFactory {
  ...
  $o_975->spec_name = 'amp-tiktok extension .js script';
  ...
  $o_977->value = 'amp-tiktok';
  $o_977->dispatch_key = true;
  $o_975->attrs[] = $o_977;
  $o_978 = new AttrSpec();
  $o_978->name = 'src';
  $o_978->mandatory = true;
  $o_978->value_regex = 'https://cdn\\.ampproject\\.org/v0/amp-tiktok-(latest|0\\.1).js';
  $o_975->attrs[] = $o_978;
  $o_979 = new AttrSpec();
  $o_979->name = 'type';
  $o_979->value = 'text/javascript';
  $o_975->attrs[] = $o_979;
  $o_975->spec_url = 'https://amp.dev/documentation/components/amp-tiktok/?format=websites';
  $o_980 = new CdataSpec();
  ...
  $o_0->tags[] = $o_975;
  $o_982 = new TagSpec();
  $o_982->tag_name = 'amp-tiktok';
  $o_983 = new AttrSpec();
  $o_983->name = 'data-src';
  $o_983->mandatory_oneof = '[\'data-src\', \'src\']';
  $o_982->attrs[] = $o_983;
  $o_984 = new AttrSpec();
  $o_984->name = 'src';
  $o_984->mandatory_oneof = '[\'data-src\', \'src\']';
  $o_985 = new UrlSpec();
  ...
  $o_982->spec_url = 'https://amp.dev/documentation/components/amp-tiktok/?format=websites';
  $o_986 = new AmpLayout();
  ...
  $o_982->also_requires_tag = ['amp-tiktok extension .js script'];
  $o_0->tags[] = $o_982;
  $o_987 = new TagSpec();
  $o_987->tag_name = 'script';
  $o_987->spec_name = 'amp-twitter extension .js script';
  ...
  $o_989->value = 'amp-twitter';
  $o_989->dispatch_key = true;
  $o_987->attrs[] = $o_989;
  $o_990 = new AttrSpec();
  $o_990->name = 'src';
  $o_990->mandatory = true;
  $o_990->value_regex = 'https://cdn\\.ampproject\\.org/v0/amp-twitter-(latest|0\\.1).js';
  $o_987->attrs[] = $o_990;
  $o_991 = new AttrSpec();
  $o_991->name = 'type';
  $o_991->value = 'text/javascript';
  $o_987->attrs[] = $o_991;
  $o_987->spec_url = 'https://www.ampproject.org/docs/reference/extended/amp-twitter.html';
  $o_992 = new CdataSpec();
  ...
  $o_0->tags[] = $o_987;
  $o_994 = new TagSpec();
  $o_994->tag_name = 'amp-twitter';
  $o_995 = new AttrSpec();
  $o_995->name = 'data-tweetid';
  $o_995->mandatory_oneof = '[\'data-tweetid\', \'src\']';
  $o_994->attrs[] = $o_995;
  $o_996 = new AttrSpec();
  $o_996->name = 'src';
  $o_996->mandatory_oneof = '[\'data-tweetid\', \'src\']';
  $o_997 = new UrlSpec();
  $o_997->allowed_protocol = ['http', 'https'];
  $o_997->allow_relative = true;
  $o_996->value_url = $o_997;
  $o_994->attrs[] = $o_996;
  $o_994->attr_lists = ['extended-amp-global'];
  $o_994->spec_url = 'https://www.ampproject.org/docs/reference/extended/amp-twitter.html';
  $o_998 = new AmpLayout();
  $o_998->supported_layouts = [AmpLayoutLayout::FILL, AmpLayoutLayout::FIXED, AmpLayoutLayout::FIXED_HEIGHT, AmpLayoutLayout::FLEX_ITEM, AmpLayoutLayout::NODISPLAY, AmpLayoutLayout::RESPONSIVE];
  $o_994->amp_layout = $o_998;
  $o_994->disallowed_ancestor = ['head', 'amp-sidebar'];
  $o_994->also_requires_tag = ['amp-twitter extension .js script'];
  $o_0->tags[] = $o_994;
  $o_999 = new TagSpec();
  $o_999->tag_name = 'script';
  $o_999->spec_name = 'amp-user-notification extension .js script';
  ...
  $o_1001->value = 'amp-user-notification';
  $o_1001->dispatch_key = true;
  $o_999->attrs[] = $o_1001;
  $o_1002 = new AttrSpec();
  $o_1002->name = 'src';
  $o_1002->mandatory = true;
  $o_1002->value_regex = 'https://cdn\\.ampproject\\.org/v0/amp-user-notification-(latest|0\\.1).js';
  $o_999->attrs[] = $o_1002;
  $o_1003 = new AttrSpec();
  $o_1003->name = 'type';
  $o_1003->value = 'text/javascript';
  $o_999->attrs[] = $o_1003;
  $o_999->spec_url = 'https://www.ampproject.org/docs/reference/extended/amp-user-notification.html';
  ...
  $o_0->tags[] = $o_999;
  $o_1006 = new TagSpec();
  $o_1006->tag_name = 'amp-user-notification';
  $o_1006->attr_lists = ['extended-amp-global'];
  $o_1006->spec_url = 'https://www.ampproject.org/docs/reference/extended/amp-user-notification.html';
  $o_1007 = new AmpLayout();
  $o_1007->supported_layouts = [AmpLayoutLayout::NODISPLAY];
  $o_1006->amp_layout = $o_1007;
  $o_1006->disallowed_ancestor = ['head', 'amp-sidebar'];
  $o_1006->also_requires_tag = ['amp-analytics extension .js script', 'amp-user-notification extension .js script'];
  $o_0->tags[] = $o_1006;
  $o_1008 = new TagSpec();
  $o_1008->tag_name = 'script';
  $o_1008->spec_name = 'amp-vimeo extension .js script';
  $o_1008->mandatory_parent = 'head';
  $o_1009 = new AttrSpec();
  $o_1009->name = 'async';
  ...
  $o_1008->attrs[] = $o_1009;
  $o_1010 = new AttrSpec();
  $o_1010->name = 'custom-element';
  $o_1010->mandatory = true;
  $o_1010->value = 'amp-vimeo';
  $o_1010->dispatch_key = true;
  $o_1008->attrs[] = $o_1010;
  $o_1011 = new AttrSpec();
  $o_1011->name = 'src';
  $o_1011->mandatory = true;
  $o_1011->value_regex = 'https://cdn\\.ampproject\\.org/v0/amp-vimeo-(latest|0\\.1)\\.js';
  $o_1008->attrs[] = $o_1011;
  $o_1012 = new AttrSpec();
  $o_1012->name = 'type';
  $o_1012->value = 'text/javascript';
  $o_1008->attrs[] = $o_1012;
  $o_1008->spec_url = 'https://www.ampproject.org/docs/reference/extended/amp-vimeo.html';
  $o_1013 = new CdataSpec();
  $o_1014 = new BlackListedCDataRegex();
  $o_1014->regex = '.';
  $o_1014->error_message = 'contents';
  $o_1013->blacklisted_cdata_regex[] = $o_1014;
  $o_1008->cdata = $o_1013;
  $o_0->tags[] = $o_1008;
  $o_1015 = new TagSpec();
  $o_1015->tag_name = 'amp-vimeo';
  $o_1016 = new AttrSpec();
  $o_1016->name = 'data-videoid';
  $o_1016->mandatory = true;
  $o_1016->value_regex = '[0-9]+';
  $o_1015->attrs[] = $o_1016;
  $o_1015->attr_lists = ['extended-amp-global'];
  $o_1015->spec_url = 'https://www.ampproject.org/docs/reference/extended/amp-vimeo.html';
  $o_1017 = new AmpLayout();
  $o_1017->supported_layouts = [AmpLayoutLayout::FILL, AmpLayoutLayout::FIXED, AmpLayoutLayout::FIXED_HEIGHT, AmpLayoutLayout::FLEX_ITEM, AmpLayoutLayout::RESPONSIVE];
  $o_1015->amp_layout = $o_1017;
  $o_1015->disallowed_ancestor = ['head', 'amp-sidebar'];
  $o_1015->also_requires_tag = ['amp-vimeo extension .js script'];
  $o_0->tags[] = $o_1015;
  $o_1018 = new TagSpec();
  $o_1018->tag_name = 'script';
  $o_1018->spec_name = 'amp-vine extension .js script';
  $o_1018->mandatory_parent = 'head';
  $o_1019 = new AttrSpec();
  $o_1019->name = 'async';
  ...
  $o_1018->attrs[] = $o_1019;
  $o_1020 = new AttrSpec();
  $o_1020->name = 'custom-element';
  $o_1020->mandatory = true;
  $o_1020->value = 'amp-vine';
  $o_1020->dispatch_key = true;
  $o_1018->attrs[] = $o_1020;
  $o_1021 = new AttrSpec();
  $o_1021->name = 'src';
  $o_1021->mandatory = true;
  $o_1021->value_regex = 'https://cdn\\.ampproject\\.org/v0/amp-vine-(latest|0\\.1).js';
  $o_1018->attrs[] = $o_1021;
  $o_1022 = new AttrSpec();
  $o_1022->name = 'type';
  $o_1022->value = 'text/javascript';
  $o_1018->attrs[] = $o_1022;
  $o_1018->spec_url = 'https://www.ampproject.org/docs/reference/extended/amp-vine.html';
  $o_1023 = new CdataSpec();
  $o_1024 = new BlackListedCDataRegex();
  $o_1024->regex = '.';
  $o_1024->error_message = 'contents';
  $o_1023->blacklisted_cdata_regex[] = $o_1024;
  $o_1018->cdata = $o_1023;
  $o_0->tags[] = $o_1018;
  $o_1025 = new TagSpec();
  $o_1025->tag_name = 'amp-vine';
  $o_1026 = new AttrSpec();
  $o_1026->name = 'data-vineid';
  $o_1026->mandatory = true;
  $o_1025->attrs[] = $o_1026;
  $o_1025->attr_lists = ['extended-amp-global'];
  $o_1025->spec_url = 'https://www.ampproject.org/docs/reference/extended/amp-vine.html';
  $o_1027 = new AmpLayout();
  $o_1027->supported_layouts = [AmpLayoutLayout::FILL, AmpLayoutLayout::FIXED, AmpLayoutLayout::FIXED_HEIGHT, AmpLayoutLayout::FLEX_ITEM, AmpLayoutLayout::NODISPLAY, AmpLayoutLayout::RESPONSIVE];
  $o_1025->amp_layout = $o_1027;
  $o_1025->disallowed_ancestor = ['head', 'amp-sidebar'];
  $o_1025->also_requires_tag = ['amp-vine extension .js script'];
  $o_0->tags[] = $o_1025;
  $o_1028 = new TagSpec();
  $o_1028->tag_name = 'script';
  $o_1028->spec_name = 'amp-youtube extension .js script';
  $o_1028->mandatory_parent = 'head';
  $o_1029 = new AttrSpec();
  $o_1029->name = 'async';
  $o_1029->mandatory = true;
  $o_1029->value = '';
  $o_1028->attrs[] = $o_1029;
  $o_1030 = new AttrSpec();
  $o_1030->name = 'custom-element';
  $o_1030->mandatory = true;
  $o_1030->value = 'amp-youtube';
  $o_1030->dispatch_key = true;
  $o_1028->attrs[] = $o_1030;
  $o_1031 = new AttrSpec();
  $o_1031->name = 'src';
  $o_1031->mandatory = true;
  $o_1031->value_regex = 'https://cdn\\.ampproject\\.org/v0/amp-youtube-(latest|0\\.1)\\.js';
  $o_1028->attrs[] = $o_1031;
  $o_1032 = new AttrSpec();
  $o_1032->name = 'type';
  $o_1032->value = 'text/javascript';
  $o_1028->attrs[] = $o_1032;
  $o_1028->spec_url = 'https://www.ampproject.org/docs/reference/extended/amp-youtube.html';
  $o_1033 = new CdataSpec();
  $o_1034 = new BlackListedCDataRegex();
  $o_1034->regex = '.';
  $o_1034->error_message = 'contents';
  $o_1033->blacklisted_cdata_regex[] = $o_1034;
  $o_1028->cdata = $o_1033;
  $o_0->tags[] = $o_1028;
  $o_1035 = new TagSpec();
  $o_1035->tag_name = 'amp-youtube';
  $o_1036 = new AttrSpec();
  $o_1036->name = 'data-videoid';
  $o_1036->mandatory_oneof = '[\'src\', \'data-videoid\']';
  $o_1035->attrs[] = $o_1036;
  $o_1037 = new AttrSpec();
  $o_1037->name = 'src';
  $o_1037->mandatory_oneof = '[\'src\', \'data-videoid\']';
  $o_1038 = new UrlSpec();
  $o_1038->allowed_protocol = ['http', 'https'];
  $o_1038->allow_relative = true;
  $o_1037->value_url = $o_1038;
  $o_1035->attrs[] = $o_1037;
  $o_1039 = new AttrSpec();
  $o_1039->name = 'video-id';
  $o_1039->deprecation = 'data-videoid';
  $o_1039->deprecation_url = 'https://www.ampproject.org/docs/reference/extended/amp-youtube.html';
  $o_1039->mandatory_oneof = '[\'src\', \'data-videoid\']';
  $o_1035->attrs[] = $o_1039;
  $o_1035->attr_lists = ['extended-amp-global'];
  $o_1035->spec_url = 'https://www.ampproject.org/docs/reference/extended/amp-youtube.html';
  $o_1040 = new AmpLayout();
  $o_1040->supported_layouts = [AmpLayoutLayout::FILL, AmpLayoutLayout::FIXED, AmpLayoutLayout::FIXED_HEIGHT, AmpLayoutLayout::FLEX_ITEM, AmpLayoutLayout::NODISPLAY, AmpLayoutLayout::RESPONSIVE];
  $o_1035->amp_layout = $o_1040;
  $o_1035->disallowed_ancestor = ['head', 'amp-sidebar'];
  $o_1035->also_requires_tag = ['amp-youtube extension .js script'];
  $o_0->tags[] = $o_1035;
  $o_0->min_validator_revision_required = 135;
  $o_0->spec_file_revision = 228;
  $o_1041 = new AttrList();
  $o_1041->name = 'common-link-attrs';
  $o_1042 = new AttrSpec();
  $o_1042->name = 'media';
  $o_1041->attrs[] = $o_1042;
  $o_1043 = new AttrSpec();
  ...
  $o_1048->name = 'color';
  $o_1041->attrs[] = $o_1048;
  $o_0->attr_lists[] = $o_1041;
  $o_1049 = new AttrList();
  $o_1049->name = 'cite-attr';
  $o_1050 = new AttrSpec();
  $o_1050->name = 'cite';
  $o_1051 = new UrlSpec();
  $o_1051->allowed_protocol = ['http', 'https', 'mailto', 'ftp', 'fb-messenger', 'sms', 'tel', 'viber', 'whatsapp'];
  $o_1051->allow_relative = true;
  $o_1050->value_url = $o_1051;
  $o_1049->attrs[] = $o_1050;
  $o_0->attr_lists[] = $o_1049;
  $o_1052 = new AttrList();
  $o_1052->name = 'track-attrs-no-subtitles';
  $o_1053 = new AttrSpec();
  $o_1053->name = 'src';
  $o_1053->mandatory = true;
  $o_1054 = new UrlSpec();
  $o_1054->allowed_protocol = ['https'];
  $o_1054->allow_relative = false;
  $o_1053->value_url = $o_1054;
  $o_1052->attrs[] = $o_1053;
  $o_1055 = new AttrSpec();
  $o_1055->name = 'default';
  $o_1055->value = '';
  ...
  $o_1056 = new AttrSpec();
  $o_1056->name = 'kind';
  $o_1056->value_regex = '(captions|descriptions|chapters|metadata)';
  $o_1052->attrs[] = $o_1056;
  $o_1057 = new AttrSpec();
  $o_1057->name = 'label';
  $o_1052->attrs[] = $o_1057;
  ...
  $o_1058->name = 'srclang';
  $o_1052->attrs[] = $o_1058;
  $o_0->attr_lists[] = $o_1052;
  $o_1059 = new AttrList();
  $o_1059->name = 'track-attrs-subtitles';
  $o_1060 = new AttrSpec();
  $o_1060->name = 'src';
  ...
  $o_1059->attrs[] = $o_1065;
  $o_0->attr_lists[] = $o_1059;
  $o_1066 = new AttrList();
  $o_1066->name = 'svg-conditional-processing-attributes';
  $o_1067 = new AttrSpec();
  $o_1067->name = 'requiredextensions';
  $o_1066->attrs[] = $o_1067;
  $o_1068 = new AttrSpec();
  $o_1068->name = 'requiredfeatures';
  $o_1066->attrs[] = $o_1068;
  $o_1069 = new AttrSpec();
  $o_1069->name = 'systemlanguage';
  $o_1066->attrs[] = $o_1069;
  $o_0->attr_lists[] = $o_1066;
  $o_1070 = new AttrList();
  $o_1070->name = 'svg-core-attributes';
  $o_1071 = new AttrSpec();
  $o_1071->name = 'xml:base';
  $o_1070->attrs[] = $o_1071;
  $o_1072 = new AttrSpec();
  $o_1072->name = 'xml:lang';
  $o_1070->attrs[] = $o_1072;
  $o_1073 = new AttrSpec();
  $o_1073->name = 'xml:space';
  $o_1070->attrs[] = $o_1073;
  $o_1074 = new AttrSpec();
  $o_1074->name = 'xmlns';
  $o_1070->attrs[] = $o_1074;
  $o_1075 = new AttrSpec();
  $o_1075->name = 'xmlns:xlink';
  $o_1070->attrs[] = $o_1075;
  $o_0->attr_lists[] = $o_1070;
  $o_1076 = new AttrList();
  $o_1076->name = 'svg-filter-primitive-attributes';
  $o_1077 = new AttrSpec();
  $o_1077->name = 'height';
  $o_1076->attrs[] = $o_1077;
  $o_1078 = new AttrSpec();
  ...
  $o_1081->name = 'y';
  $o_1076->attrs[] = $o_1081;
  $o_0->attr_lists[] = $o_1076;
  $o_1082 = new AttrList();
  $o_1082->name = 'svg-presentation-attributes';
  $o_1083 = new AttrSpec();
  $o_1083->name = 'alignment-baseline';
  $o_1082->attrs[] = $o_1083;
  $o_1084 = new AttrSpec();
  $o_1084->name = 'baseline-shift';
  $o_1082->attrs[] = $o_1084;
  $o_1085 = new AttrSpec();
  $o_1085->name = 'clip';
  $o_1082->attrs[] = $o_1085;
  $o_1086 = new AttrSpec();
  $o_1086->name = 'clip-path';
  $o_1082->attrs[] = $o_1086;
  $o_1087 = new AttrSpec();
  $o_1087->name = 'clip-rule';
  $o_1082->attrs[] = $o_1087;
  $o_1088 = new AttrSpec();
  $o_1088->name = 'color';
  $o_1082->attrs[] = $o_1088;
  $o_1089 = new AttrSpec();
  $o_1089->name = 'color-interpolation';
  $o_1082->attrs[] = $o_1089;
  $o_1090 = new AttrSpec();
  $o_1090->name = 'color-interpolation-filters';
  $o_1082->attrs[] = $o_1090;
  $o_1091 = new AttrSpec();
  $o_1091->name = 'color-profile';
  $o_1082->attrs[] = $o_1091;
  $o_1092 = new AttrSpec();
  $o_1092->name = 'color-rendering';
  $o_1082->attrs[] = $o_1092;
  $o_1093 = new AttrSpec();
  $o_1093->name = 'cursor';
  $o_1082->attrs[] = $o_1093;
  $o_1094 = new AttrSpec();
  $o_1094->name = 'direction';
  $o_1082->attrs[] = $o_1094;
  $o_1095 = new AttrSpec();
  $o_1095->name = 'display';
  $o_1082->attrs[] = $o_1095;
  $o_1096 = new AttrSpec();
  $o_1096->name = 'dominant-baseline';
  $o_1082->attrs[] = $o_1096;
  $o_1097 = new AttrSpec();
  $o_1097->name = 'enable-background';
  $o_1082->attrs[] = $o_1097;
  $o_1098 = new AttrSpec();
  $o_1098->name = 'fill';
  $o_1082->attrs[] = $o_1098;
  $o_1099 = new AttrSpec();
  $o_1099->name = 'fill-opacity';
  $o_1082->attrs[] = $o_1099;
  $o_1100 = new AttrSpec();
  $o_1100->name = 'fill-rule';
  $o_1082->attrs[] = $o_1100;
  $o_1101 = new AttrSpec();
  $o_1101->name = 'filter';
  $o_1082->attrs[] = $o_1101;
  $o_1102 = new AttrSpec();
  $o_1102->name = 'flood-color';
  $o_1082->attrs[] = $o_1102;
  $o_1103 = new AttrSpec();
  $o_1103->name = 'flood-opacity';
  $o_1082->attrs[] = $o_1103;
  $o_1104 = new AttrSpec();
  $o_1104->name = 'font-family';
  $o_1082->attrs[] = $o_1104;
  $o_1105 = new AttrSpec();
  $o_1105->name = 'font-size';
  $o_1082->attrs[] = $o_1105;
  $o_1106 = new AttrSpec();
  $o_1106->name = 'font-size-adjust';
  $o_1082->attrs[] = $o_1106;
  $o_1107 = new AttrSpec();
  $o_1107->name = 'font-stretch';
  $o_1082->attrs[] = $o_1107;
  $o_1108 = new AttrSpec();
  $o_1108->name = 'font-style';
  $o_1082->attrs[] = $o_1108;
  $o_1109 = new AttrSpec();
  $o_1109->name = 'font-variant';
  $o_1082->attrs[] = $o_1109;
  $o_1110 = new AttrSpec();
  $o_1110->name = 'font-weight';
  $o_1082->attrs[] = $o_1110;
  $o_1111 = new AttrSpec();
  $o_1111->name = 'glyph-orientation-horizontal';
  $o_1082->attrs[] = $o_1111;
  $o_1112 = new AttrSpec();
  $o_1112->name = 'glyph-orientation-vertical';
  $o_1082->attrs[] = $o_1112;
  $o_1113 = new AttrSpec();
  $o_1113->name = 'image-rendering';
  $o_1082->attrs[] = $o_1113;
  $o_1114 = new AttrSpec();
  $o_1114->name = 'kerning';
  $o_1082->attrs[] = $o_1114;
  $o_1115 = new AttrSpec();
  $o_1115->name = 'letter-spacing';
  $o_1082->attrs[] = $o_1115;
  $o_1116 = new AttrSpec();
  $o_1116->name = 'lighting-color';
  $o_1082->attrs[] = $o_1116;
  $o_1117 = new AttrSpec();
  $o_1117->name = 'marker-end';
  $o_1082->attrs[] = $o_1117;
  $o_1118 = new AttrSpec();
  $o_1118->name = 'marker-mid';
  $o_1082->attrs[] = $o_1118;
  $o_1119 = new AttrSpec();
  $o_1119->name = 'marker-start';
  $o_1082->attrs[] = $o_1119;
  $o_1120 = new AttrSpec();
  $o_1120->name = 'mask';
  $o_1082->attrs[] = $o_1120;
  ...
  $o_1082->attrs[] = $o_1121;
  $o_1122 = new AttrSpec();
  $o_1122->name = 'overflow';
  $o_1082->attrs[] = $o_1122;
  $o_1123 = new AttrSpec();
  $o_1123->name = 'pointer-events';
  $o_1082->attrs[] = $o_1123;
  $o_1124 = new AttrSpec();
  $o_1124->name = 'shape-rendering';
  $o_1082->attrs[] = $o_1124;
  $o_1125 = new AttrSpec();
  $o_1125->name = 'stop-color';
  $o_1082->attrs[] = $o_1125;
  $o_1126 = new AttrSpec();
  $o_1126->name = 'stop-opacity';
  $o_1082->attrs[] = $o_1126;
  $o_1127 = new AttrSpec();
  $o_1127->name = 'stroke';
  $o_1082->attrs[] = $o_1127;
  $o_1128 = new AttrSpec();
  $o_1128->name = 'stroke-dasharray';
  $o_1082->attrs[] = $o_1128;
  $o_1129 = new AttrSpec();
  $o_1129->name = 'stroke-dashoffset';
  $o_1082->attrs[] = $o_1129;
  $o_1130 = new AttrSpec();
  $o_1130->name = 'stroke-linecap';
  $o_1082->attrs[] = $o_1130;
  $o_1131 = new AttrSpec();
  $o_1131->name = 'stroke-linejoin';
  $o_1082->attrs[] = $o_1131;
  $o_1132 = new AttrSpec();
  $o_1132->name = 'stroke-miterlimit';
  $o_1082->attrs[] = $o_1132;
  $o_1133 = new AttrSpec();
  $o_1133->name = 'stroke-opacity';
  $o_1082->attrs[] = $o_1133;
  $o_1134 = new AttrSpec();
  $o_1134->name = 'stroke-width';
  $o_1082->attrs[] = $o_1134;
  $o_1135 = new AttrSpec();
  $o_1135->name = 'text-anchor';
  $o_1082->attrs[] = $o_1135;
  $o_1136 = new AttrSpec();
  $o_1136->name = 'text-decoration';
  $o_1082->attrs[] = $o_1136;
  $o_1137 = new AttrSpec();
  $o_1137->name = 'text-rendering';
  $o_1082->attrs[] = $o_1137;
  $o_1138 = new AttrSpec();
  $o_1138->name = 'unicode-bidi';
  $o_1082->attrs[] = $o_1138;
  $o_1139 = new AttrSpec();
  $o_1139->name = 'visibility';
  $o_1082->attrs[] = $o_1139;
  $o_1140 = new AttrSpec();
  $o_1140->name = 'word-spacing';
  $o_1082->attrs[] = $o_1140;
  $o_1141 = new AttrSpec();
  $o_1141->name = 'writing-mode';
  $o_1082->attrs[] = $o_1141;
  $o_0->attr_lists[] = $o_1082;
  $o_1142 = new AttrList();
  $o_1142->name = 'svg-transfer-function-attributes';
  $o_1143 = new AttrSpec();
  $o_1143->name = 'amplitude';
  $o_1142->attrs[] = $o_1143;
  $o_1144 = new AttrSpec();
  $o_1144->name = 'exponent';
  $o_1142->attrs[] = $o_1144;
  $o_1145 = new AttrSpec();
  $o_1145->name = 'intercept';
  $o_1142->attrs[] = $o_1145;
  $o_1146 = new AttrSpec();
  $o_1146->name = 'offset';
  $o_1142->attrs[] = $o_1146;
  ...
  $o_1142->attrs[] = $o_1148;
  $o_1149 = new AttrSpec();
  $o_1149->name = 'tablevalues';
  $o_1142->attrs[] = $o_1149;
  $o_0->attr_lists[] = $o_1142;
  $o_1150 = new AttrList();
  $o_1150->name = 'svg-xlink-attributes';
  $o_1151 = new AttrSpec();
  $o_1151->name = 'xlink:actuate';
  $o_1150->attrs[] = $o_1151;
  $o_1152 = new AttrSpec();
  $o_1152->name = 'xlink:arcrole';
  $o_1150->attrs[] = $o_1152;
  $o_1153 = new AttrSpec();
  $o_1153->name = 'xlink:href';
  $o_1153->value_regex = '#.*';
  $o_1150->attrs[] = $o_1153;
  $o_1154 = new AttrSpec();
  $o_1154->name = 'xlink:role';
  $o_1150->attrs[] = $o_1154;
  $o_1155 = new AttrSpec();
  $o_1155->name = 'xlink:show';
  $o_1150->attrs[] = $o_1155;
  $o_1156 = new AttrSpec();
  $o_1156->name = 'xlink:title';
  $o_1150->attrs[] = $o_1156;
  $o_1157 = new AttrSpec();
  $o_1157->name = 'xlink:type';
  $o_1150->attrs[] = $o_1157;
  $o_0->attr_lists[] = $o_1150;
  $o_1158 = new AttrList();
  $o_1158->name = 'mandatory-src-or-srcset';
  $o_1159 = new AttrSpec();
  $o_1159->name = 'src';
  $o_1159->alternative_names = ['srcset'];
  $o_1159->mandatory = true;
  $o_1160 = new UrlSpec();
  $o_1160->allowed_protocol = ['data', 'http', 'https'];
  $o_1160->allow_relative = true;
  $o_1159->value_url = $o_1160;
  $o_1158->attrs[] = $o_1159;
  $o_0->attr_lists[] = $o_1158;
  $o_1161 = new AttrList();
  $o_1161->name = 'extended-amp-global';
  $o_1162 = new AttrSpec();
  $o_1162->name = 'media';
  $o_1161->attrs[] = $o_1162;
  $o_1163 = new AttrSpec();
  $o_1163->name = 'noloading';
  $o_1163->value = '';
  $o_1161->attrs[] = $o_1163;
  $o_0->attr_lists[] = $o_1161;
  $o_1164 = new AttrList();
  $o_1164->name = '$AMP_LAYOUT_ATTRS';
  $o_1165 = new AttrSpec();
  $o_1165->name = 'height';
  $o_1164->attrs[] = $o_1165;
  $o_1166 = new AttrSpec();
  ...
  $o_1169->name = 'width';
  $o_1164->attrs[] = $o_1169;
  $o_0->attr_lists[] = $o_1164;
  $o_1170 = new AttrList();
  $o_1170->name = '$GLOBAL_ATTRS';
  $o_1171 = new AttrSpec();
  $o_1171->name = 'itemid';
  $o_1170->attrs[] = $o_1171;
  $o_1172 = new AttrSpec();
  $o_1172->name = 'itemprop';
  $o_1170->attrs[] = $o_1172;
  $o_1173 = new AttrSpec();
  $o_1173->name = 'itemref';
  $o_1170->attrs[] = $o_1173;
  $o_1174 = new AttrSpec();
  $o_1174->name = 'itemscope';
  $o_1170->attrs[] = $o_1174;
  $o_1175 = new AttrSpec();
  $o_1175->name = 'itemtype';
  $o_1170->attrs[] = $o_1175;
  $o_1176 = new AttrSpec();
  $o_1176->name = 'accesskey';
  $o_1170->attrs[] = $o_1176;
  $o_1177 = new AttrSpec();
  $o_1177->name = 'class';
  $o_1170->attrs[] = $o_1177;
  ...
  $o_1170->attrs[] = $o_1181;
  $o_1182 = new AttrSpec();
  $o_1182->name = 'tabindex';
  $o_1170->attrs[] = $o_1182;
  $o_1183 = new AttrSpec();
  $o_1183->name = 'title';
  $o_1170->attrs[] = $o_1183;
  $o_1184 = new AttrSpec();
  $o_1184->name = 'translate';
  $o_1170->attrs[] = $o_1184;
  $o_1185 = new AttrSpec();
  $o_1185->name = 'aria-activedescendant';
  $o_1170->attrs[] = $o_1185;
  $o_1186 = new AttrSpec();
  $o_1186->name = 'aria-atomic';
  $o_1170->attrs[] = $o_1186;
  $o_1187 = new AttrSpec();
  $o_1187->name = 'aria-autocomplete';
  $o_1170->attrs[] = $o_1187;
  $o_1188 = new AttrSpec();
  $o_1188->name = 'aria-busy';
  $o_1170->attrs[] = $o_1188;
  $o_1189 = new AttrSpec();
  $o_1189->name = 'aria-checked';
  $o_1170->attrs[] = $o_1189;
  $o_1190 = new AttrSpec();
  $o_1190->name = 'aria-controls';
  $o_1170->attrs[] = $o_1190;
  $o_1191 = new AttrSpec();
  $o_1191->name = 'aria-describedby';
  $o_1170->attrs[] = $o_1191;
  $o_1192 = new AttrSpec();
  $o_1192->name = 'aria-disabled';
  $o_1170->attrs[] = $o_1192;
  $o_1193 = new AttrSpec();
  $o_1193->name = 'aria-dropeffect';
  $o_1170->attrs[] = $o_1193;
  $o_1194 = new AttrSpec();
  $o_1194->name = 'aria-expanded';
  $o_1170->attrs[] = $o_1194;
  $o_1195 = new AttrSpec();
  $o_1195->name = 'aria-flowto';
  $o_1170->attrs[] = $o_1195;
  $o_1196 = new AttrSpec();
  $o_1196->name = 'aria-grabbed';
  $o_1170->attrs[] = $o_1196;
  $o_1197 = new AttrSpec();
  $o_1197->name = 'aria-haspopup';
  $o_1170->attrs[] = $o_1197;
  $o_1198 = new AttrSpec();
  $o_1198->name = 'aria-hidden';
  $o_1170->attrs[] = $o_1198;
  $o_1199 = new AttrSpec();
  $o_1199->name = 'aria-invalid';
  $o_1170->attrs[] = $o_1199;
  $o_1200 = new AttrSpec();
  $o_1200->name = 'aria-label';
  $o_1170->attrs[] = $o_1200;
  $o_1201 = new AttrSpec();
  $o_1201->name = 'aria-labelledby';
  $o_1170->attrs[] = $o_1201;
  $o_1202 = new AttrSpec();
  $o_1202->name = 'aria-level';
  $o_1170->attrs[] = $o_1202;
  $o_1203 = new AttrSpec();
  $o_1203->name = 'aria-live';
  $o_1170->attrs[] = $o_1203;
  $o_1204 = new AttrSpec();
  $o_1204->name = 'aria-multiline';
  $o_1170->attrs[] = $o_1204;
  $o_1205 = new AttrSpec();
  $o_1205->name = 'aria-multiselectable';
  $o_1170->attrs[] = $o_1205;
  $o_1206 = new AttrSpec();
  $o_1206->name = 'aria-orientation';
  $o_1170->attrs[] = $o_1206;
  $o_1207 = new AttrSpec();
  $o_1207->name = 'aria-owns';
  $o_1170->attrs[] = $o_1207;
  $o_1208 = new AttrSpec();
  $o_1208->name = 'aria-posinset';
  $o_1170->attrs[] = $o_1208;
  $o_1209 = new AttrSpec();
  $o_1209->name = 'aria-pressed';
  $o_1170->attrs[] = $o_1209;
  $o_1210 = new AttrSpec();
  $o_1210->name = 'aria-readonly';
  $o_1170->attrs[] = $o_1210;
  $o_1211 = new AttrSpec();
  $o_1211->name = 'aria-relevant';
  $o_1170->attrs[] = $o_1211;
  $o_1212 = new AttrSpec();
  $o_1212->name = 'aria-required';
  $o_1170->attrs[] = $o_1212;
  $o_1213 = new AttrSpec();
  $o_1213->name = 'aria-selected';
  $o_1170->attrs[] = $o_1213;
  $o_1214 = new AttrSpec();
  $o_1214->name = 'aria-setsize';
  $o_1170->attrs[] = $o_1214;
  $o_1215 = new AttrSpec();
  $o_1215->name = 'aria-sort';
  $o_1170->attrs[] = $o_1215;
  $o_1216 = new AttrSpec();
  $o_1216->name = 'aria-valuemax';
  $o_1170->attrs[] = $o_1216;
  $o_1217 = new AttrSpec();
  $o_1217->name = 'aria-valuemin';
  $o_1170->attrs[] = $o_1217;
  $o_1218 = new AttrSpec();
  $o_1218->name = 'aria-valuenow';
  $o_1170->attrs[] = $o_1218;
  $o_1219 = new AttrSpec();
  $o_1219->name = 'aria-valuetext';
  $o_1170->attrs[] = $o_1219;
  $o_1220 = new AttrSpec();
  $o_1220->name = 'on';
  $o_1221 = new AttrTriggerSpec();
  $o_1221->if_value_regex = 'tap:.*';
  $o_1221->also_requires_attr = ['role', 'tabindex'];
  $o_1220->trigger = $o_1221;
  $o_1170->attrs[] = $o_1220;
  $o_1222 = new AttrSpec();
  $o_1222->name = 'role';
  $o_1170->attrs[] = $o_1222;
  $o_1223 = new AttrSpec();
  $o_1223->name = 'placeholder';
  $o_1223->value = '';
  $o_1170->attrs[] = $o_1223;
  $o_1224 = new AttrSpec();
  $o_1224->name = 'fallback';
  $o_1224->value = '';
  $o_1170->attrs[] = $o_1224;
  $o_1225 = new AttrSpec();
  $o_1225->name = 'lightbox';
  $o_1170->attrs[] = $o_1225;
  $o_1226 = new AttrSpec();
  $o_1226->name = 'overflow';
  $o_1170->attrs[] = $o_1226;
  $o_1227 = new AttrSpec();
  $o_1227->name = 'amp-access';
  $o_1170->attrs[] = $o_1227;
  $o_1228 = new AttrSpec();
  $o_1228->name = 'amp-access-behavior';
  $o_1170->attrs[] = $o_1228;
  $o_1229 = new AttrSpec();
  $o_1229->name = 'amp-access-hide';
  $o_1170->attrs[] = $o_1229;
  $o_1230 = new AttrSpec();
  $o_1230->name = 'amp-access-id';
  $o_1170->attrs[] = $o_1230;
  $o_1231 = new AttrSpec();
  $o_1231->name = 'amp-access-loader';
  $o_1170->attrs[] = $o_1231;
  $o_1232 = new AttrSpec();
  $o_1232->name = 'amp-access-loading';
  $o_1170->attrs[] = $o_1232;
  $o_1233 = new AttrSpec();
  $o_1233->name = 'amp-access-off';
  $o_1170->attrs[] = $o_1233;
  $o_1234 = new AttrSpec();
  $o_1234->name = 'amp-access-on';
  $o_1170->attrs[] = $o_1234;
  $o_1235 = new AttrSpec();
  $o_1235->name = 'amp-access-show';
  $o_1170->attrs[] = $o_1235;
  $o_1236 = new AttrSpec();
  $o_1236->name = 'amp-access-style';
  $o_1170->attrs[] = $o_1236;
  $o_1237 = new AttrSpec();
  $o_1237->name = 'amp-access-template';
  $o_1170->attrs[] = $o_1237;
  $o_1238 = new AttrSpec();
  $o_1238->name = 'i-amp-access-id';
  $o_1170->attrs[] = $o_1238;
  $o_0->attr_lists[] = $o_1170;
  $o_0->template_spec_url = 'https://www.ampproject.org/docs/reference/extended/amp-mustache.html';
  $o_1239 = new ErrorFormat();
  $o_1239->code = ValidationErrorCode::UNKNOWN_CODE;
  $o_1239->format = 'Unknown error.';
  $o_0->error_formats[] = $o_1239;
  $o_1240 = new ErrorFormat();
  $o_1240->code = ValidationErrorCode::MANDATORY_TAG_MISSING;
  $o_1240->format = 'The mandatory tag \'%1\' is missing or incorrect.';
  $o_0->error_formats[] = $o_1240;
  $o_1241 = new ErrorFormat();
  $o_1241->code = ValidationErrorCode::TAG_REQUIRED_BY_MISSING;
  $o_1241->format = 'The tag \'%1\' is missing or incorrect, but required by \'%2\'.';
  $o_0->error_formats[] = $o_1241;
  $o_1242 = new ErrorFormat();
  $o_1242->code = ValidationErrorCode::ATTR_REQUIRED_BUT_MISSING;
  $o_1242->format = 'The attribute \'%1\' in tag \'%2\' is missing or incorrect, but required by attribute \'%3\'.';
  $o_0->error_formats[] = $o_1242;
  $o_1243 = new ErrorFormat();
  $o_1243->code = ValidationErrorCode::DISALLOWED_TAG;
  $o_1243->format = 'The tag \'%1\' is disallowed.';
  $o_0->error_formats[] = $o_1243;
  $o_1244 = new ErrorFormat();
  $o_1244->code = ValidationErrorCode::GENERAL_DISALLOWED_TAG;
  $o_1244->format = 'The tag \'%1\' is disallowed except in specific forms.';
  $o_0->error_formats[] = $o_1244;
  $o_1245 = new ErrorFormat();
  $o_1245->code = ValidationErrorCode::DISALLOWED_ATTR;
  $o_1245->format = 'The attribute \'%1\' may not appear in tag \'%2\'.';
  $o_0->error_formats[] = $o_1245;
  $o_1246 = new ErrorFormat();
  $o_1246->code = ValidationErrorCode::INVALID_ATTR_VALUE;
  $o_1246->format = 'The attribute \'%1\' in tag \'%2\' is set to the invalid value \'%3\'.';
  $o_0->error_formats[] = $o_1246;
  $o_1247 = new ErrorFormat();
  $o_1247->code = ValidationErrorCode::ATTR_VALUE_REQUIRED_BY_LAYOUT;
  $o_1247->format = 'Invalid value \'%1\' for attribute \'%2\' in tag \'%3\' - for layout \'%4\', set the attribute \'%2\' to value \'%5\'.';
  $o_0->error_formats[] = $o_1247;
  $o_1248 = new ErrorFormat();
  $o_1248->code = ValidationErrorCode::IMPLIED_LAYOUT_INVALID;
  $o_1248->format = 'The implied layout \'%1\' is not supported by tag \'%2\'.';
  $o_0->error_formats[] = $o_1248;
  $o_1249 = new ErrorFormat();
  $o_1249->code = ValidationErrorCode::SPECIFIED_LAYOUT_INVALID;
  $o_1249->format = 'The specified layout \'%1\' is not supported by tag \'%2\'.';
  $o_0->error_formats[] = $o_1249;
  $o_1250 = new ErrorFormat();
  $o_1250->code = ValidationErrorCode::MANDATORY_ATTR_MISSING;
  $o_1250->format = 'The mandatory attribute \'%1\' is missing in tag \'%2\'.';
  $o_0->error_formats[] = $o_1250;
  $o_1251 = new ErrorFormat();
  $o_1251->code = ValidationErrorCode::INCONSISTENT_UNITS_FOR_WIDTH_AND_HEIGHT;
  $o_1251->format = 'Inconsistent units for width and height in tag \'%1\' - width is specified in \'%2\' whereas height is specified in \'%3\'.';
  $o_0->error_formats[] = $o_1251;
  $o_1252 = new ErrorFormat();
  $o_1252->code = ValidationErrorCode::STYLESHEET_TOO_LONG_OLD_VARIANT;
  $o_1252->format = 'The author stylesheet specified in tag \'style amp-custom\' is too long - we saw %1 bytes whereas the limit is %2 bytes.';
  $o_0->error_formats[] = $o_1252;
  $o_1253 = new ErrorFormat();
  $o_1253->code = ValidationErrorCode::STYLESHEET_TOO_LONG;
  $o_1253->format = 'The author stylesheet specified in tag \'%1\' is too long - we saw %2 bytes whereas the limit is %3 bytes.';
  $o_0->error_formats[] = $o_1253;
  $o_1254 = new ErrorFormat();
  $o_1254->code = ValidationErrorCode::MANDATORY_CDATA_MISSING_OR_INCORRECT;
  $o_1254->format = 'The mandatory text (CDATA) inside tag \'%1\' is missing or incorrect.';
  $o_0->error_formats[] = $o_1254;
  $o_1255 = new ErrorFormat();
  $o_1255->code = ValidationErrorCode::CDATA_VIOLATES_BLACKLIST;
  $o_1255->format = 'The text (CDATA) inside tag \'%1\' contains \'%2\', which is disallowed.';
  $o_0->error_formats[] = $o_1255;
  $o_1256 = new ErrorFormat();
  $o_1256->code = ValidationErrorCode::DISALLOWED_PROPERTY_IN_ATTR_VALUE;
  $o_1256->format = 'The property \'%1\' in attribute \'%2\' in tag \'%3\' is disallowed.';
  $o_0->error_formats[] = $o_1256;
  $o_1257 = new ErrorFormat();
  $o_1257->code = ValidationErrorCode::INVALID_PROPERTY_VALUE_IN_ATTR_VALUE;
  $o_1257->format = 'The property \'%1\' in attribute \'%2\' in tag \'%3\' is set to \'%4\', which is invalid.';
  $o_0->error_formats[] = $o_1257;
  $o_1258 = new ErrorFormat();
  $o_1258->code = ValidationErrorCode::DUPLICATE_DIMENSION;
  $o_1258->format = 'Multiple image candidates with the same width or pixel density found in attribute \'%1\' in tag \'%2\'.';
  $o_0->error_formats[] = $o_1258;
  $o_1259 = new ErrorFormat();
  $o_1259->code = ValidationErrorCode::MISSING_URL;
  $o_1259->format = 'Missing URL for attribute \'%1\' in tag \'%2\'.';
  $o_0->error_formats[] = $o_1259;
  $o_1260 = new ErrorFormat();
  $o_1260->code = ValidationErrorCode::INVALID_URL;
  $o_1260->format = 'Malformed URL \'%3\' for attribute \'%1\' in tag \'%2\'.';
  $o_0->error_formats[] = $o_1260;
  $o_1261 = new ErrorFormat();
  $o_1261->code = ValidationErrorCode::INVALID_URL_PROTOCOL;
  $o_1261->format = 'Invalid URL protocol \'%3:\' for attribute \'%1\' in tag \'%2\'.';
  $o_0->error_formats[] = $o_1261;
  $o_1262 = new ErrorFormat();
  $o_1262->code = ValidationErrorCode::DISALLOWED_RELATIVE_URL;
  $o_1262->format = 'The relative URL \'%3\' for attribute \'%1\' in tag \'%2\' is disallowed.';
  $o_0->error_formats[] = $o_1262;
  $o_1263 = new ErrorFormat();
  $o_1263->code = ValidationErrorCode::MANDATORY_PROPERTY_MISSING_FROM_ATTR_VALUE;
  $o_1263->format = 'The property \'%1\' is missing from attribute \'%2\' in tag \'%3\'.';
  $o_0->error_formats[] = $o_1263;
  $o_1264 = new ErrorFormat();
  $o_1264->code = ValidationErrorCode::UNESCAPED_TEMPLATE_IN_ATTR_VALUE;
  $o_1264->format = 'The attribute \'%1\' in tag \'%2\' is set to \'%3\', which contains unescaped Mustache template syntax.';
  $o_0->error_formats[] = $o_1264;
  $o_1265 = new ErrorFormat();
  $o_1265->code = ValidationErrorCode::TEMPLATE_PARTIAL_IN_ATTR_VALUE;
  $o_1265->format = 'The attribute \'%1\' in tag \'%2\' is set to \'%3\', which contains a Mustache template partial.';
  $o_0->error_formats[] = $o_1265;
  $o_1266 = new ErrorFormat();
  $o_1266->code = ValidationErrorCode::DEPRECATED_TAG;
  $o_1266->format = 'The tag \'%1\' is deprecated - use \'%2\' instead.';
  $o_0->error_formats[] = $o_1266;
  $o_1267 = new ErrorFormat();
  $o_1267->code = ValidationErrorCode::DEPRECATED_ATTR;
  $o_1267->format = 'The attribute \'%1\' in tag \'%2\' is deprecated - use \'%3\' instead.';
  $o_0->error_formats[] = $o_1267;
  $o_1268 = new ErrorFormat();
  $o_1268->code = ValidationErrorCode::DEV_MODE_ENABLED;
  $o_1268->format = 'The attribute \'%1\' in tag \'%2\' enables the development mode. Please remove, this feature is obsolete.';
  $o_0->error_formats[] = $o_1268;
  $o_1269 = new ErrorFormat();
  $o_1269->code = ValidationErrorCode::MUTUALLY_EXCLUSIVE_ATTRS;
  $o_1269->format = 'Mutually exclusive attributes encountered in tag \'%1\' - pick one of %2.';
  $o_0->error_formats[] = $o_1269;
  $o_1270 = new ErrorFormat();
  $o_1270->code = ValidationErrorCode::MANDATORY_ONEOF_ATTR_MISSING;
  $o_1270->format = 'The tag \'%1\' is missing a mandatory attribute - pick one of %2.';
  $o_0->error_formats[] = $o_1270;
  $o_1271 = new ErrorFormat();
  $o_1271->code = ValidationErrorCode::WRONG_PARENT_TAG;
  $o_1271->format = 'The parent tag of tag \'%1\' is \'%2\', but it can only be \'%3\'.';
  $o_0->error_formats[] = $o_1271;
  $o_1272 = new ErrorFormat();
  $o_1272->code = ValidationErrorCode::DISALLOWED_TAG_ANCESTOR;
  $o_1272->format = 'The tag \'%1\' may not appear as a descendant of tag \'%2\'.';
  $o_0->error_formats[] = $o_1272;
  $o_1273 = new ErrorFormat();
  $o_1273->code = ValidationErrorCode::MANDATORY_TAG_ANCESTOR;
  $o_1273->format = 'The tag \'%1\' may only appear as a descendant of tag \'%2\'.';
  $o_0->error_formats[] = $o_1273;
  $o_1274 = new ErrorFormat();
  $o_1274->code = ValidationErrorCode::MANDATORY_TAG_ANCESTOR_WITH_HINT;
  $o_1274->format = 'The tag \'%1\' may only appear as a descendant of tag \'%2\'. Did you mean \'%3\'?';
  $o_0->error_formats[] = $o_1274;
  $o_1275 = new ErrorFormat();
  $o_1275->code = ValidationErrorCode::DUPLICATE_UNIQUE_TAG;
  $o_1275->format = 'The tag \'%1\' appears more than once in the document.';
  $o_0->error_formats[] = $o_1275;
  $o_1276 = new ErrorFormat();
  $o_1276->code = ValidationErrorCode::TEMPLATE_IN_ATTR_NAME;
  $o_1276->format = 'Mustache template syntax in attribute name \'%1\' in tag \'%2\'.';
  $o_0->error_formats[] = $o_1276;
  $o_1277 = new ErrorFormat();
  $o_1277->code = ValidationErrorCode::ATTR_DISALLOWED_BY_IMPLIED_LAYOUT;
  $o_1277->format = 'The attribute \'%1\' in tag \'%2\' is disallowed by implied layout \'%3\'.';
  $o_0->error_formats[] = $o_1277;
  $o_1278 = new ErrorFormat();
  $o_1278->code = ValidationErrorCode::ATTR_DISALLOWED_BY_SPECIFIED_LAYOUT;
  $o_1278->format = 'The attribute \'%1\' in tag \'%2\' is disallowed by specified layout \'%3\'.';
  $o_0->error_formats[] = $o_1278;
  $o_1279 = new ErrorFormat();
  $o_1279->code = ValidationErrorCode::INCORRECT_NUM_CHILD_TAGS;
  $o_1279->format = 'Tag \'%1\' must have %2 child tags - saw %3 child tags.';
  $o_0->error_formats[] = $o_1279;
  $o_1280 = new ErrorFormat();
  $o_1280->code = ValidationErrorCode::DISALLOWED_CHILD_TAG_NAME;
  $o_1280->format = 'Tag \'%1\' is disallowed as child of tag \'%2\'. Child tag must be one of %3.';
  $o_0->error_formats[] = $o_1280;
  $o_1281 = new ErrorFormat();
  $o_1281->code = ValidationErrorCode::DISALLOWED_FIRST_CHILD_TAG_NAME;
  $o_1281->format = 'Tag \'%1\' is disallowed as first child of tag \'%2\'. First child tag must be one of %3.';
  $o_0->error_formats[] = $o_1281;
  $o_1282 = new ErrorFormat();
  $o_1282->code = ValidationErrorCode::CSS_SYNTAX;
  $o_1282->format = 'CSS syntax error in tag \'%1\' - %2.';
  $o_0->error_formats[] = $o_1282;
  $o_1283 = new ErrorFormat();
  $o_1283->code = ValidationErrorCode::CSS_SYNTAX_INVALID_AT_RULE;
  $o_1283->format = 'CSS syntax error in tag \'%1\' - saw invalid at rule \'@%2\'.';
  $o_0->error_formats[] = $o_1283;
  $o_1284 = new ErrorFormat();
  $o_1284->code = ValidationErrorCode::CSS_SYNTAX_STRAY_TRAILING_BACKSLASH;
  $o_1284->format = 'CSS syntax error in tag \'%1\' - stray trailing backslash.';
  $o_0->error_formats[] = $o_1284;
  $o_1285 = new ErrorFormat();
  $o_1285->code = ValidationErrorCode::CSS_SYNTAX_UNTERMINATED_COMMENT;
  $o_1285->format = 'CSS syntax error in tag \'%1\' - unterminated comment.';
  $o_0->error_formats[] = $o_1285;
  $o_1286 = new ErrorFormat();
  $o_1286->code = ValidationErrorCode::CSS_SYNTAX_UNTERMINATED_STRING;
  $o_1286->format = 'CSS syntax error in tag \'%1\' - unterminated string.';
  $o_0->error_formats[] = $o_1286;
  $o_1287 = new ErrorFormat();
  $o_1287->code = ValidationErrorCode::CSS_SYNTAX_BAD_URL;
  $o_1287->format = 'CSS syntax error in tag \'%1\' - bad url.';
  $o_0->error_formats[] = $o_1287;
  $o_1288 = new ErrorFormat();
  $o_1288->code = ValidationErrorCode::CSS_SYNTAX_EOF_IN_PRELUDE_OF_QUALIFIED_RULE;
  $o_1288->format = 'CSS syntax error in tag \'%1\' - end of stylesheet encountered in prelude of a qualified rule.';
  $o_0->error_formats[] = $o_1288;
  $o_1289 = new ErrorFormat();
  $o_1289->code = ValidationErrorCode::CSS_SYNTAX_INVALID_DECLARATION;
  $o_1289->format = 'CSS syntax error in tag \'%1\' - invalid declaration.';
  $o_0->error_formats[] = $o_1289;
  $o_1290 = new ErrorFormat();
  $o_1290->code = ValidationErrorCode::CSS_SYNTAX_INCOMPLETE_DECLARATION;
  $o_1290->format = 'CSS syntax error in tag \'%1\' - incomplete declaration.';
  $o_0->error_formats[] = $o_1290;
  $o_1291 = new ErrorFormat();
  $o_1291->code = ValidationErrorCode::CSS_SYNTAX_ERROR_IN_PSEUDO_SELECTOR;
  $o_1291->format = 'CSS syntax error in tag \'%1\' - invalid pseudo selector.';
  $o_0->error_formats[] = $o_1291;
  $o_1292 = new ErrorFormat();
  $o_1292->code = ValidationErrorCode::CSS_SYNTAX_MISSING_SELECTOR;
  $o_1292->format = 'CSS syntax error in tag \'%1\' - missing selector.';
  $o_0->error_formats[] = $o_1292;
  $o_1293 = new ErrorFormat();
  $o_1293->code = ValidationErrorCode::CSS_SYNTAX_NOT_A_SELECTOR_START;
  $o_1293->format = 'CSS syntax error in tag \'%1\' - not a selector start.';
  $o_0->error_formats[] = $o_1293;
  $o_1294 = new ErrorFormat();
  $o_1294->code = ValidationErrorCode::CSS_SYNTAX_UNPARSED_INPUT_REMAINS_IN_SELECTOR;
  $o_1294->format = 'CSS syntax error in tag \'%1\' - unparsed input remains in selector.';
  $o_0->error_formats[] = $o_1294;
  $o_1295 = new ErrorFormat();
  $o_1295->code = ValidationErrorCode::CSS_SYNTAX_MISSING_URL;
  $o_1295->format = 'CSS syntax error in tag \'%1\' - missing url.';
  $o_0->error_formats[] = $o_1295;
  $o_1296 = new ErrorFormat();
  $o_1296->code = ValidationErrorCode::CSS_SYNTAX_INVALID_URL;
  $o_1296->format = 'CSS syntax error in tag \'%1\' - invalid url \'%2\'.';
  $o_0->error_formats[] = $o_1296;
  $o_1297 = new ErrorFormat();
  $o_1297->code = ValidationErrorCode::CSS_SYNTAX_INVALID_URL_PROTOCOL;
  $o_1297->format = 'CSS syntax error in tag \'%1\' - invalid url protocol \'%2:\'.';
  $o_0->error_formats[] = $o_1297;
  $o_1298 = new ErrorFormat();
  $o_1298->code = ValidationErrorCode::CSS_SYNTAX_DISALLOWED_RELATIVE_URL;
  $o_1298->format = 'CSS syntax error in tag \'%1\' - disallowed relative url \'%2\'.';
  $o_0->error_formats[] = $o_1298;
  $o_1299 = new ErrorFormat();
  $o_1299->code = ValidationErrorCode::CSS_SYNTAX_INVALID_ATTR_SELECTOR;
  $o_1299->format = 'CSS syntax error in tag \'%1\' - invalid attribute selector.';
